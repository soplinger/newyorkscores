...
public class Main {
    ...
    public static void main(String[] args) throws IOException, InputMismatchException {
        ...
        for (int i = 1; i <= maxIndx; i++) {
            ...
            String math2 = "0", reading2 = "0", writing2 = "0";
        ...
        System.out.println("");
        System.out.println("Highest SAT Average: " + Schools.highestSchool + " " + Schools.satHighest);
        System.out.println("Second SAT Average: " + Schools.secondSchool + " " + Schools.satSecond);
        System.out.println("Third SAT Average: " + Schools.thirdSchool + " " + Schools.satThird);
        System.out.println("New York State Average: " + Schools.stateAverage);
    }
